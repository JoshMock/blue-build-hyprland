...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ...
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/joshmock/blue-build-hyprland:latest
  ```
...
- Then rebase to the signed image, like so:
  ...
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/blue-build/blue-build-hyprland:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/joshmock/blue-build-hyprland
```
